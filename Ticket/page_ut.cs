...
namespace Ticket
{
    public partial class page_ut : Form
    {
        ...
        public page_ut()
        {
            ...
            rectableLayoutPanel_ut = new Rectangle(tableLayoutPanel_ut.Location, tableLayoutPanel_ut.Size);
        ...
        {
            list_suite ls_suite = new list_suite();
            ls_suite.Show();
            this.Hide();
        }
        ...
        {
            list_melati ls_melati = new list_melati();
            ls_melati.Show();
            this.Hide();
        }
        ...
        {
            list_mawar ls_mawar = new list_mawar();
            ls_mawar.Show();
            this.Hide();
        }
        ...
        {
            list_dahlia ls_dahlia = new list_dahlia();
            ls_dahlia.Show();
            this.Hide();
        }
        ...
        {
            resize_Control(tableLayoutPanel_ut, rectableLayoutPanel_ut);
